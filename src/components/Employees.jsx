...
export default function Employees() {
  ...
  function handleSave() {
    ...
    if (age < 18) return setError("O funcionário deve ter no mínimo 18 anos.");
        ...
        <Modal title="Novo funcionário" onClose={() => setShowModal(false)}>
          <div className="space-y-4">
            ...
            <div className="flex gap-2 justify-end pt-1">
              ...
              <button onClick={handleSave} className="btn-save">Cadastrar</button>
            </div>
          </div>
        </Modal>
      )}
