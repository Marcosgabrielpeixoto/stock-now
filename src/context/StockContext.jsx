...
const initialProducts = [
  { id: 1, name: "Farinha de trigo", category: "Alimentos", qty: 50, unit: "kg", minQty: 10 },
  { id: 2, name: "Detergente", category: "Limpeza", qty: 3, unit: "un", minQty: 5 },
  { id: 3, name: "Água mineral", category: "Bebidas", qty: 0, unit: "L", minQty: 12 },
  { id: 4, name: "Papel A4", category: "Escritório", qty: 8, unit: "cx", minQty: 2 },
  { id: 5, name: "Sabonete", category: "Higiene", qty: 20, unit: "un", minQty: 10 },
];
